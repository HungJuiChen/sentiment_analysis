...
Project Structure
Report: IE4483_Artificial_Intelligence_and_Data_Mining_Report.pdf – Contains a detailed explanation of feature selection, model architecture, training strategy, and model performance.
Notebook: sentiment_analysis.ipynb – Jupyter Notebook used for data processing, model training, and evaluation.
Submission File: submission.csv – Output file containing the model's predictions on test data.
Features
...
git clone <repo-link>
cd <repo-name>
Open the Jupyter Notebook sentiment_analysis.ipynb and run all cells sequentially.
Alternatively, you can run the notebook on Google Colab: Google Colab Link
...
Wong Yu Hao 
References
Refer to the project report for full citations and methodology details.
